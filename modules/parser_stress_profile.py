...
from . import structural_profile
...
def build_parser() -> argparse.ArgumentParser:
    parser = structural_profile.build_parser(LEGACY_PROFILE)
    parser.description = (
...
def parse_args() -> argparse.Namespace:
    ...
    if args.sizes is None:
        args.sizes = (
            structural_profile.payload_gen.BOUNDARY_SIZES
...
def iter_cases(args: argparse.Namespace) -> Iterable[dict[str, Any]]:
    args.stress_profile = LEGACY_PROFILE
    for case in structural_profile.iter_cases(args):
